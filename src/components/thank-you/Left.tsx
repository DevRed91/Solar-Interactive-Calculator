...
const ThankYouLeft = ({ status }: IThankYouLeft) => {
  ...
  return (
    <div className="flex h-full w-full flex-col justify-between gap-8 bg-[url('/images/background/step-nine.webp')] bg-top bg-repeat-x p-15">
      <div className="flex flex-col gap-8">
        ...
        <div className="border-b-black-100 flex w-[1176px] items-center justify-between border-b pb-[35px]">
        ...
        {isVersion2 ? (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-6">
              {dictionary.thankYou.left.expectSection.data?.map(
                (item, index) => (
                  <div
                    key={index}
                    className="border-background-400 flex w-[438px] flex-col items-center overflow-hidden rounded-xl border"
                  >
                    <MixColorsText
                      content={item.content}
                      className="z-[1] overflow-visible p-5 pb-0"
                      contentClassName="!text-2xl/[34px] !font-dm-sans -tracking-[0.96px] whitespace-pre-wrap"
                    />
                    ...
                    <div className="relative h-full w-full">
                      ...
                      />
                      <div className="absolute -top-6 left-0 h-[100px] w-full rotate-180 bg-linear-(--thank-you-gradient)" />
                    </div>
                  </div>
                ),
              )}
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex h-[330px] gap-6">
              {dictionary.thankYou.left.expectSection.data2?.map(
                (item, index) => (
                  <div
                    key={index}
                    className="border-background-400 flex w-[438px] flex-col items-center overflow-hidden rounded-xl border p-5 pt-0"
                  >
                    <div className="relative min-w-fit">
                      ...
                      />
                      <div className="absolute -bottom-5 left-0 h-[100px] w-full bg-linear-(--thank-you-gradient)" />
                    </div>
                    <MixColorsText
                      content={item.content}
                      className="z-[1]"
      ...
      <div className="flex w-[90%] items-center gap-6">
        <Button
          variant="primary"
          content={dictionary['thankYou'].left.buttons.home}
          leftIcon={
          ...
          className="!w-[512px]"
        />
        <p className="text-black-400 font-dm-sans w-[446px] [&>*]:text-[28px]/[39px] [&>span]:font-normal">
          {renderStyledText(dictionary.thankYou.left.redirectNote, {
